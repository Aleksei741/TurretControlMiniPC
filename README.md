...
|Описание|Turret|Control|Sensor|Parameters|Delay|Read|Количество HP, шт|...|Резерв|Резерв|Константа|Константа|
...
|Описание|Turret|Control|Sensor|Parameters|Delay|Read|Задерка до сгорания HP, мин|...|Резерв|Резерв|Константа|Константа|
...
|Описание|Turret|Control|Sensor|Parameters|Delay|Read|Задерка до сгорания HP, сек|...|Резерв|Резерв|Константа|Константа|
